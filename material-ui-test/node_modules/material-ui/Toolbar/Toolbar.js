...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiToolbar', function (theme) {
  var _root;
  ...
  return {
    root: (_root = {
      ...
      alignItems: 'center',
      minHeight: 56
    }, (0, _defineProperty3.default)(_root, theme.breakpoints.up('xs') + ' and (orientation: landscape)', {
      minHeight: 48
    }), (0, _defineProperty3.default)(_root, theme.breakpoints.up('sm'), {
      minHeight: 64
    }), _root),
