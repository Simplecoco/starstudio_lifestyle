...
if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_TransitionCallback', {
  value: require('prop-types').func,
  configurable: true
});
if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_TransitionRequestTimeout', {
  value: require('prop-types').func,
  configurable: true
});
...
Transition.propTypes = process.env.NODE_ENV !== "production" ? (_ref2 = {
  ...
  children: typeof ReactElement === 'function' ? require('prop-types').instanceOf(ReactElement) : require('prop-types').any,
