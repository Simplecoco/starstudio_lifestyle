...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiDialogActions', function (theme) {
  return {
    root: {
      display: 'flex',
...
function DialogActions(props) {
  ...
  return _react2.default.createElement(
    ...
    _react.Children.map(children, function (button) {
      return (0, _react.isValidElement)(button) && _react2.default.createElement(
        'div',
...
exports.default = (0, _withStyles2.default)(styleSheet)(DialogActions);